...
<body class="bg-dark">
  ...
  <div  style="position: fixed; bottom: 18px; right: 12px; width:auto;">
    <a href="../" style=" text-decoration: none; color:white; margin:4px"><ion-icon name="arrow-back-circle-outline" size="large"></ion-icon></a>
  </div>
